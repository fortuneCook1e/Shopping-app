...
import { Box, Heading, HStack, IconButton, Image, Text, 
  useColorModeValue, useDisclosure, useToast, VStack,
  ModalOverlay, ModalContent, ModalHeader, ModalBody, 
  ModalCloseButton, Input, Modal, ModalFooter, Button} from '@chakra-ui/react';
...
const ProductCard = ({product}) => {
  ...
  const handleDeleteProduct = async (productId) => {
    ...
    console.log('handleDeleteProduct', success, message);
    if (!success) {
      toast({
        title: 'Error',
        description: message,
  ...
  const handleUpdateProduct = async (productId, updatedProduct) => {
    ...
    console.log('handleUpdateProduct: ',success, message);
    if (!success) {
      toast({
        title: 'Error',
        description: message,
